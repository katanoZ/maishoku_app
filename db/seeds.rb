...
#association
Shop.find(1).areas = Area.where(id: [1, 2, 3])
Shop.find(2).areas = Area.where(id: [1, 2, 3, 4])
Shop.find(3).areas = Area.where(id: [5, 6])
Shop.find(4).areas = Area.where(id: [1, 2, 3, 4, 5, 6])
Shop.find(5).areas = Area.where(id: 4)

Genre.find(1).dishes = Dish.where(id: 1)
Genre.find(2).dishes = Dish.where(id: [2, 3, 4, 5])
Genre.find(3).dishes = Dish.where(id: [6, 9, 10])
Genre.find(4).dishes = Dish.where(id: [7, 9, 10])
Genre.find(5).dishes = Dish.where(id: [8, 9, 11])

Shop.find(1).dishes = Dish.where(id: [2, 3, 4, 5])
Shop.find(2).dishes = Dish.where(id: 1)
Shop.find(3).dishes = Dish.where(id: [8, 11])
Shop.find(4).dishes = Dish.where(id: [7])
Shop.find(5).dishes = Dish.where(id: [6, 9, 10])

Kind.find(1).dishes = Dish.where(id: 8)
Kind.find(2).dishes = Dish.where(id: [3, 8])
Kind.find(3).dishes = Dish.where(id: [1, 2, 4, 5, 6, 7, 9, 10, 11])
Kind.find(4).dishes = Dish.where(id: [7, 9, 10])

Shop.find(1).kinds = Kind.where(id: [2, 3])
Shop.find(2).kinds = Kind.where(id: 3)
